      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <a href="/patient" className="text-slate-600 hover:text-slate-900 transition text-sm">
              Patient Portal
            </a>
            <a href="/doctor" className="text-slate-600 hover:text-slate-900 transition text-sm">
              Doctor Portal
            </a>
            <a href="/admin" className="text-slate-600 hover:text-slate-900 transition text-sm">
              Admin Portal
            </a>
          </div>
